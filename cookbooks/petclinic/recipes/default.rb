...
remote_file '/opt/tomcat_petclinicserver_8_0_36/webapps/petclinic.war' do
    source 'http://192.168.0.19:8081/artifactory/libs-snapshot-local/org/springframework/samples/spring-petclinic/1.0.0-SNAPSHOT/spring-petclinic-1.0.0-20180812.235756-1.war'
